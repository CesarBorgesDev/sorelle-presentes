...
ALTER TABLE orders ADD COLUMN IF NOT EXISTS mercado_pago_preference_id VARCHAR(64);
ALTER TABLE orders ADD COLUMN IF NOT EXISTS mercado_pago_payment_id VARCHAR(64);
ALTER TABLE orders ADD COLUMN IF NOT EXISTS mercado_pago_authorization_code VARCHAR(128);
...
ALTER TABLE users ADD COLUMN IF NOT EXISTS address_district VARCHAR(120);
ALTER TABLE users ADD COLUMN IF NOT EXISTS address_city VARCHAR(120);
...
-- Subcategorias: coluna parent_id (bases novas e existentes)
